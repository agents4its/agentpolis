...
//            Connection fromConnection = connectionsMappedByNodes.get(fromNode);
            ...
            Lane endLane = new Lane(link, link.getLength(), timeProvider);
            link.setEndLane(endLane);
            link.addLane(endLane, toNode);
            if (toConnection instanceof Crossroad) {
                ((Crossroad) toConnection).addNextLink(null, endLane, null);
            } else {
                toConnection.setOutLink(null, endLane);
            }        }
    }
